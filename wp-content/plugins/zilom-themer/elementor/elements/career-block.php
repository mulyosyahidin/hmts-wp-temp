...
class GVAElement_Career_Block extends GVAElement_Base {
	...
	public function get_title() {
		return __( 'GVA Career Block', 'zilom-themer' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					'url' => GAVIAS_ZILOM_PLUGIN_URL . 'elementor/assets/images/icon.png',
				],
			]
		);
		...
		$this->add_control(
			'job_type',
			[
				'label' => __( 'Job Type', 'zilom-themer' ),
				'type' => Controls_Manager::TEXT,
				'default' => 'Full Time'
			]
		);
		...
		$this->start_controls_section(
			'info_type_style',
			[
				'label' => __( 'Information (Address & Company)', 'zilom-themer' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
