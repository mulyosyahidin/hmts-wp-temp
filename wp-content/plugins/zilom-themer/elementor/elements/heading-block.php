...
class GVAElement_Heading_Block extends GVAElement_Base {
	...
	public function get_title() {
		return __( 'GVA Heading Block', 'zilom-themer' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'Enter your Sub Title', 'zilom-themer' ),
				'label_block' => true
			]
		);
		...
		$this->add_control(
			'box_align',
			[
				'label' => __( 'Alignment Box', 'zilom-themer' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => __( 'Left', 'zilom-themer' ),
		...
		$this->add_responsive_control(
			'max_width',
			[
				'label' => __( 'Max Width (px)', 'zilom-themer' ),
		...
		$this->add_control(
			'auto_responsive',
			[
				'label' => __( 'Auto Responsive', 'zilom-themer' ),
				'type' => Controls_Manager::SWITCHER,
				'placeholder' => __( 'Auto Responsive size of title', 'zilom-themer' ),
				'default' => 'yes'
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Icon', 'zilom-themer' ),
				'type' => Controls_Manager::SWITCHER,
				'placeholder' => __( 'Enable/Disable Icon Heading', 'zilom-themer' ),
				'default' => 'no'
			]
		);
		...
		$this->add_control(
			'icon_image',
			[
				'label' => __( 'Icon Image', 'zilom-themer' ),
		...
		$this->start_controls_section( //** Section Icon
			'section_video',
			[
				'label' => __( 'Video Top', 'zilom-themer' ),
			]
		);
		$this->add_control(
			'video',
			[
				'label' => __( 'Video', 'zilom-themer' ),
				'type' => Controls_Manager::SWITCHER,
				'placeholder' => __( 'Enable/Disable Video Heading', 'zilom-themer' ),
				'default' => 'no'
			]
		);
		$this->add_control(
			'video_url',
			[
				'label' => __( 'Video Youtube or Vimeo URL', 'zilom-themer' ),
				'type' => Controls_Manager::TEXT,
				'condition' => [
					'video' => 'yes',
				],
		...
		$this->add_control(
			'button_size',
			[
				'label' => __( 'Button Size', 'zilom-themer' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' 					=> esc_html__('Button Size Default', 'zilom-themer'),
					'btn-size-small' 	=> esc_html__('Button Small', 'zilom-themer'),
					'btn-medium' 		=> esc_html__('Button Medium', 'zilom-themer')
				],
				'default' => '',
			]
		);
		$this->add_control(
			'button_color',
			[
				'label' => __( 'Button Text Color', 'zilom-themer' ),
		...
		$this->add_control(
			'button_background',
			[
				'label' => __( 'Button Background', 'zilom-themer' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'button_color_hover',
			[
				'label' => __( 'Button Color Hover', 'zilom-themer' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Button Background Hover', 'zilom-themer' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
