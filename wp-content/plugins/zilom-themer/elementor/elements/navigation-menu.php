...
class GVAElement_Navigation_Menu extends GVAElement_Base {
	...
	public function get_title() {
		return __( 'GVA Navigation Menu', 'zilom-themer' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'sub_menu_min_width',
			[
				'label' => __( 'Submenu Min Width (px)', 'zilom-themer' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Main Menu', 'zilom-themer' ),
      ...
      $this->add_control(
         'menu_top_line_color',
         [
            'label'     => __('Top Line Color', 'zilom-themer'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Sub Menu', 'zilom-themer' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
      ...
      $this->add_control(
         ...
         [
            'label'     => __('Link Color', 'zilom-themer'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
