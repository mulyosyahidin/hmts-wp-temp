...
class Zilom_Addons_Wishlist_Ajax{
	...
	public function __construct(){
		add_action('wp_ajax_zilom_wishlist', array($this, 'wishlist_add'));
		add_action('wp_ajax_nopriv_zilom_wishlist', array($this, 'wishlist_add'));
	}
	...
	?>
		<div class="wishlist-icon-content">
			<a href="#" data-post_id="<?php echo esc_attr($post_id) ?>" class="ajax-wishlist-link <?php echo (!$check_wishlist ? 'wishlist-add' : 'wishlist-remove wishlist-added') ?>" title="<?php echo esc_attr__('Wishlist', 'zilom-themer') ?>">
...
new Zilom_Addons_Wishlist_Ajax();