...
interface ScriptableContext<TParsedData extends unknown> {
  active: boolean;
  chart: Chart;
  dataIndex: number;
...
type Scriptable<T, TType> = T | (TType extends ChartType ? { [TT in TType]: ((ctx: ScriptableContext<ParsedDataType<TT>>) => T) }[TType] : ((ctx: TType) => T));
type ScriptableOptions<T, TType extends ChartType> = { [P in keyof T]: Scriptable<T[P], TType> };
type ScriptableAndArray<T, TType extends ChartType> = readonly T[] | Scriptable<T, TType>;
type ScriptableAndArrayOptions<T, TType extends ChartType> = { [P in keyof T]: ScriptableAndArray<T[P], TType> };
...
export { Defaults as $, AnyObject as A, BarControllerDatasetOptions as B, ChartArea as C, DoughnutControllerDatasetOptions as D, EasingFunction as E, FontSpec as F, PieController as G, PolarAreaControllerDatasetOptions as H, PolarAreaAnimationOptions as I, PolarAreaControllerChartOptions as J, PolarAreaController as K, LineControllerDatasetOptions as L, RadarControllerChartOptions as M, RadarController as N, ChartMeta as O, PointStyle as P, ActiveDataPoint as Q, RadarControllerDatasetOptions as R, ScriptableContext as S, ActiveElement as T, Chart as U, registerables as V, ChartItem as W, UpdateModeEnum as X, UpdateMode as Y, DatasetController as Z, DatasetControllerChartComponent as _, Color as a, FillerControllerDatasetOptions as a$, defaults as a0, InteractionOptions as a1, InteractionItem as a2, InteractionModeFunction as a3, InteractionModeMap as a4, InteractionMode as a5, Interaction as a6, layouts as a7, Plugin as a8, ChartComponentLike as a9, ArcElement as aA, LineProps as aB, LineOptions as aC, LineHoverOptions as aD, LineElement as aE, PointProps as aF, PointOptions as aG, PointHoverOptions as aH, PointPrefixedOptions as aI, PointPrefixedHoverOptions as aJ, PointElement as aK, BarProps as aL, BarOptions as aM, BorderRadius as aN, BarHoverOptions as aO, BarElement as aP, ElementOptionsByType as aQ, ElementChartOptions as aR, BasePlatform as aS, BasicPlatform as aT, DomPlatform as aU, DecimationAlgorithm as aV, DecimationOptions as aW, Filler as aX, FillerOptions as aY, FillTarget as aZ, ComplexFillTarget as a_, Registry as aa, registry as ab, Tick as ac, CoreScaleOptions as ad, Scale as ae, ScriptableScaleContext as af, Ticks as ag, TypedRegistry as ah, ChartEvent as ai, ChartComponent as aj, CoreInteractionOptions as ak, HoverInteractionOptions as al, CoreChartOptions as am, AnimationSpec as an, AnimationsSpec as ao, TransitionSpec as ap, TransitionsSpec as aq, AnimationOptions as ar, TextAlign as as, VisualElement as at, CommonElementOptions as au, CommonHoverOptions as av, Segment as aw, ArcProps as ax, ArcOptions as ay, ArcHoverOptions as az, Scriptable as b, Legend as b0, LegendItem as b1, LegendElement as b2, LegendOptions as b3, Title as b4, TitleOptions as b5, TooltipAlignment as b6, TooltipModel as b7, Tooltip as b8, TooltipCallbacks as b9, DatasetChartOptions as bA, ScaleChartOptions as bB, ChartOptions as bC, DefaultDataPoint as bD, ParsedDataType as bE, ChartDatasetProperties as bF, ChartDataset as bG, ChartData as bH, ChartConfiguration as bI, DateAdapter as bJ, TimeUnit as bK, _adapters as bL, Animation as bM, Animations as bN, Animator as bO, AnimationEvent as bP, Element as bQ, Point as bR, LayoutItem as bS, LayoutPosition as bT, ExtendedPlugin as ba, TooltipOptions as bb, TooltipItem as bc, PluginOptionsByType as bd, PluginChartOptions as be, GridLineOptions as bf, TickOptions as bg, CartesianScaleOptions as bh, CategoryScaleOptions as bi, CategoryScale as bj, LinearScaleOptions as bk, LinearScale as bl, LogarithmicScaleOptions as bm, LogarithmicScale as bn, TimeScaleOptions as bo, TimeScale as bp, TimeSeriesScale as bq, RadialLinearScaleOptions as br, RadialLinearScale as bs, CartesianScaleTypeRegistry as bt, RadialScaleTypeRegistry as bu, ScaleTypeRegistry as bv, ScaleType as bw, ChartTypeRegistry as bx, ChartType as by, ScaleOptionsByType as bz, ScriptableOptions as c, ScriptableAndArray as d, ScriptableAndArrayOptions as e, ParsingOptions as f, ControllerDatasetOptions as g, BarControllerChartOptions as h, BarController as i, BubbleControllerDatasetOptions as j, BubbleDataPoint as k, BubbleController as l, LineControllerChartOptions as m, LineController as n, ScatterControllerDatasetOptions as o, ScatterDataPoint as p, ScatterControllerChartOptions as q, ScatterController as r, DoughnutAnimationOptions as s, DoughnutControllerChartOptions as t, DoughnutDataPoint as u, DoughnutController as v, PieControllerDatasetOptions as w, PieControllerChartOptions as x, PieAnimationOptions as y, PieDataPoint as z };
