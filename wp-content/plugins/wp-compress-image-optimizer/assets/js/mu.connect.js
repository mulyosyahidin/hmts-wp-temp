        ...
        $(save).on('click', function (e) {
            ...
            $.post(wps_ic_vars.ajaxurl, {action: 'wps_ic_cname_add', cname: cname_field, siteID: wpc_siteID}, function (response) {
                ...
                if (response.success) {
                    ...
                    $(configured).hide();
                    $(step_1).show();
                    $('.custom-cdn-error-message', popup).html('<span class="icon-container close-toggle"><i class="icon-cancel"></i></span> This domain is invalid, please link a new domain...').show();
                    $(step_2).hide();
                    $(step_1_retry).hide();
                }
            });
