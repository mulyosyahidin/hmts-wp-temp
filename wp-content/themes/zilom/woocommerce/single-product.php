...
if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
	...
	$default_sidebar_config = zilom_get_option('product_sidebar_config', ''); 
	$default_left_sidebar = zilom_get_option('product_left_sidebar', ''); 
	$default_right_sidebar = zilom_get_option('product_right_sidebar', ''); 
