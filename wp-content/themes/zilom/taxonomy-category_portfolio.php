 ...
 */
   ...
   $sidebar_layout_config = zilom_get_option('archive_portfolio_sidebar', 'right-sidebar'); 
   $left_sidebar = zilom_get_option('archive_portfolio_left_sidebar', 'portfolio_sidebar');
   $right_sidebar = zilom_get_option('archive_portfolio_right_sidebar', 'portfolio_sidebar');
   ...
   $columns_lg = zilom_get_option('portfolio_columns_lg', '4');
   $columns_md = zilom_get_option('portfolio_columns_md', '3');
   $columns_sm = zilom_get_option('portfolio_columns_sm', '2');
   $columns_xs = zilom_get_option('portfolio_columns_xs', '1');
