...
<?php 
	if(!get_option( 'users_can_register', false )) {
		echo '<div class="alert alert-info">' . esc_html__('Registration disabled. Please ask site admin to enable registration.', 'zilom') . '</p>';
		return;
	}
?>
	...
	<div class="row no-margin">
		...
		<div class="register-form-content col-12 col-md-7">
			...
			<div class="form-links">
				<a class="active"><?php echo esc_html__('Student', 'zilom') ?></a>
				<a href="<?php echo tutils()->instructor_register_url(); ?>"><?php echo esc_html__('Instructor', 'zilom') ?></a>
			</div>
			  ...
			  <div class="tutor-form-row">
					<div class="tutor-form-col-12">
						<div class="tutor-form-group tutor-reg-form-btn-wrap">
							<button type="submit" name="tutor_register_student_btn" value="register" class="tutor-button"><?php echo esc_html__('Register', 'zilom'); ?></button>
						</div>
					</div>
			  </div>
			</form>
