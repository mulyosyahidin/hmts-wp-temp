...
<?php do_action('tutor_lesson/single/before/lesson_sidebar'); ?>
	 ...
	 <div class="tutor-sidebar-tabs-wrap">
		...
		<?php 
			if($is_public != 'yes' && !is_user_logged_in() ){
				echo '<a href="#" data-toggle="modal" data-target="#form-ajax-login-popup" class="lessons-sidebar-ovelay"></a>';   
			}
		?>

	  	<div class="tutor-tabs-btn-group">
			<a href="#tutor-lesson-sidebar-tab-content" class="<?php echo esc_attr($enable_q_and_a_on_course ? "active" : ""); ?>">
				<i class="tutor-icon-education"></i>
				<span> <?php echo esc_html__('Lesson List', 'zilom'); ?></span>
			</a>
			<?php if($enable_q_and_a_on_course) { ?>
				<a href="#tutor-lesson-sidebar-qa-tab-content"> <i class="tutor-icon-question-1"></i> <span><?php echo esc_html__('Browse Q&A', 'zilom'); ?></span></a>
			<?php } ?>
	  	</div>
								...
								<div class="tutor-topics-in-single-lesson tutor-topics-<?php echo esc_attr($topic_id); ?>">
									...
									<?php
										...
										if($lessons->have_posts()){
											...
											?>
											  	<div class="tutor-single-lesson-items assignments-single-item assignment-single-item-<?php echo esc_attr($post->ID); ?> <?php echo esc_attr($currentPost->ID === get_the_ID() ? 'active' : ''); ?>"
				...
				?>
					...
					<div id="tutor-lesson-sidebar-qa-tab-content" class="tutor-lesson-sidebar-tab-item" style="display: none;">
						<?php
							...
							echo '<div class="alert alert-primary">'.esc_html__( 'Please login before!', 'zilom' ).'</div>';
						  }
						?>
					</div>
