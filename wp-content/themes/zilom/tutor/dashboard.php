							...
							<?php
								...
								foreach($dashboard_pages as $dashboard_key => $dashboard_page) {
									...
									if($separator){
										...
										if($dashboard_key == "my-courses"){
											if(current_user_can(tutor()->instructor_role)){
												$course_type = tutor()->course_post_type;
												echo "<li class='tutor-dashboard-menu-add-course'><a href='" . apply_filters('frontend_course_create_url', admin_url("post-new.php?post_type=".tutor()->course_post_type)) . "'>".esc_html__('Add A New Course', 'zilom')."</a> </li>";
											}
										}
